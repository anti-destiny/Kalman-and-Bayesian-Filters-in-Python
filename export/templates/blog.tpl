...
<div class="cell border-box-sizing text_cell rendered {% if 'tran' in cell['metadata'].get('tags', []) %}right{% else %}left{% endif %}"
	style="{% if 'common' not in cell['metadata'].get('tags', []) %}width:50%;float:left;{% else %}width:80%;left:10%;position:relative;{% endif %}{% if 'tran' in cell['metadata'].get('tags', []) %}line-height:150%;{% else %}{% endif %}"
>
